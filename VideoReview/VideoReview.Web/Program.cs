using VideoReview.Web.Components;
using VideoReview.Shared.Services;
using VideoReview.Web.Services;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(
        typeof(VideoReview.Shared._Imports).Assembly,
        typeof(VideoReview.Web.Client._Imports).Assembly);
